    ...
    >
          ...
          <div class="col l4 offset-l2 s12">
            ...
            <ul>
              <li>
                ...
                >
                  <AiFillGithub className="grey-text text-darken-3 icon" />{" "}
                  GitHub
                </a>
              </li>
              <li>
                ...
                >
                  <AiOutlinePhone className="grey-text text-darken-3 icon" />{" "}
                  WhatsApp
                </a>
              </li>
            </ul>
      ...
      <div class="footer-copyright">
        <div class="container">
          ...
          >
            <AiFillMail className="grey-text text-darken-3 icon" />{" "}
            jairomponti@gmail.com
          </h6>
        </div>
      </div>
    </footer>
